...
export const product = defineType({
  ...
  fields: [
    ...
    defineField({
      name: 'category',
      type: 'string',
      description: 'Used to filter products on the storefront (e.g. "Coffee", "Pantry", "Merch")',
      options: {
        list: [
    ...
    defineField({
      ...
      type: 'array',
      description: 'Editorial content managed in Sanity. Shown on the product detail page.',
      of: [{ type: 'block' }]
    }),
    defineField({
      name: 'image',
    ...
    defineField({
      name: 'modifierGroups',
      type: 'array',
      description: 'Synced from Toast. Options the customer selects at checkout (e.g. grind, size).',
      of: [
        {
          type: 'object',
          name: 'modifierGroup',
